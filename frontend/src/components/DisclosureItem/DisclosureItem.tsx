      ...
      {({ open }) => (
        <>
          ...
          <DisclosurePanel className='mt-2 text-sm/5 text-black/50'>
            ...
            {/* 
              Dummy data
              Replace with data from `GptComponent`

              e.g, item.information whereas information is the data from `GptComponent`
            */}
            flask/src/flask/init.py: Initializes the Flask module, making
            it accessible when imported. flask/src/flask/app.py: Contains
            the central class for Flask application, defining how the
            application behaves. flask/src/flask/cli.py: Handles the
            command-line interface for Flask applications.
            flask/src/flask/config.py: Manages the configuration of a
            Flask application. flask/src/flask/logging.py: Provides
            logging capabilities within Flask applications.
            flask/src/flask/sessions.py: Handles user sessions in Flask.
            flask/tests/test_logging.py: Tests the logging functionality
            of Flask. flask/tests/test_cli.py: Tests the command-line
            interface functionality. flask/tests/test_apps: Contains test
