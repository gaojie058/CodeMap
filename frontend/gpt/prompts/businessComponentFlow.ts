// src/gpt/prompts/businessComponentFlow.ts

export const businessComponentFlowPrompt = {
    name: 'businessComponentFlow',
    content: `Generate a local flow diagram for the {selectedNode} business component:
  1. Using DOT language
  2. Annotate the purpose of each edge
  3. Output important functions, variables, and file path
  
  digraph component_flow {
      rankdir=TB;
