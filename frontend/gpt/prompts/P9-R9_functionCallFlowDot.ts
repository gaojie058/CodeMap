// src/gpt/prompts/functionCallFlowDot.ts

export const functionCallFlowDotPrompt = {
    name: 'functionCallFlowDot',
    content: `Provide me with the function call flow of the {fileOrComponent} as dot file content, keeping the main functions and their call relationships in the graph, while presenting secondary functions or complex call relationships in the form of comments.
  ...
  Please generate a function call flow diagram for the file or component: {fileOrComponent}`
  };